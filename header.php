...
<nav class="navbar navbar-default navbar-fixed-top" style="background:#eeefc6">
    	...
    	<div class="collapse navbar-collapse" id="myNavbar">
	      	<ul class="nav navbar-nav navbar-right">
        		<li ><p style="margin-top:10%;">ADMINSTRATOR LOGGED IN<br><b style="font-size:12px;letter-spacing:5px">vipath admin backend</b></p></li>
	  ...
	  <a href='viewUser.php'><button class="button" id="button3">View users</button></a>
      </div>
</nav>
</body>
</html>
